...
if __name__ == '__main__':
    ...
    parser.add_argument("--images_dir", help="图像位置", default="F:\VOCdevkit\VOC2007\JPEGImages")
    parser.add_argument("--anno_dir", help="标注文件位置", default="F:\VOCdevkit\VOC2007\Annotations")
    ...
    parser.add_argument("--weights_file_path", help="模型初始权重文件位置",
                        default="C:\\Users\\不吃鱼的猫\\Desktop\\text-detection-ocr\\dlocr\\weights\\weights-ctpnlstm-init.hdf5")
